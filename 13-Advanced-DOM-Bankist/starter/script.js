...
//2. Determine where that element originated the event
...
tabsContainer.addEventListener('click', function (e) {
  ...
  //Guard Clause: New Way to guard against null and error popping up
  if (!clicked) return;
...
// message.  = 'We use cookies for improved functionality'
message.innerHTML =
